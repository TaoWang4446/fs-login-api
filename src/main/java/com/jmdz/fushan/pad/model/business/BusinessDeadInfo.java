...
/**
 *@ClassName BusinessDeadInfo
 *@Description TODO
 *@Author wangshengtao
 *@Date 2020-08-03 15:35
 *@Version 1.0
 */
@ApiModel(value = "业务洽谈逝者信息", description = "业务洽谈逝者信息")
public class BusinessDeadInfo extends BaseBean {
        /**
         * 业务编号
         */
         ...
         * 证件类型(主键）
         */
        @ApiModelProperty(value = "证件类型代码",name = "certificateType",position = 7)
        private String certificateType;

        /**
         * 证件类型（文本）
         */
        @ApiModelProperty(value = "证件类型名称",name = "certificateTypeText",position = 7)
         ...
         * 遗体类型（主键）
         */
        @ApiModelProperty(value = "遗体类型代码",name = "boneType",position = 9)
        private String boneType;

        /**
         * 遗体类型（文本）
         */
        @ApiModelProperty(value = "遗体类型名称",name = "boneTypeText",position = 9)
        private String boneTypeText;
         ...
         * 国籍（主键）
         */
        @ApiModelProperty(value = "国籍代码",name = "nationality",position = 11)
        private String nationality;

        /**
         * 国籍（文本）
         */
        @ApiModelProperty(value = "国籍名称",name = "nationalityText",position = 11)
         ...
         * 民族（主键）
         */
        @ApiModelProperty(value = "民族代码",name = "folk",position = 13)
        private String folk;

        /**
         * 民族(文本）
         */
        @ApiModelProperty(value = "民族名称",name = "folkText",position = 13)
        private String folkText;
         ...
         * 减免类型（主键）
         */
        @ApiModelProperty(value = "减免类型代码",name = "peopleType",position = 15)
        private String peopleType;

        /**
         * 减免类型(文本）
         */
        @ApiModelProperty(value = "减免类型名称",name = "peopleTypeText",position = 15)
        private String peopleTypeText;
         ...
         * 洽谈员（主键）
         */
        @ApiModelProperty(value = "洽谈员代码",name = "qiaTanYuan",position = 33)
        private String qiaTanYuan;

        /**
         * 洽谈员（文本）
         */
        @ApiModelProperty(value = "洽谈员名称",name = "qiaTanYuanText",position = 33)
        private String qiaTanYuanText;
         ...
         * 送尸联系人
         */
        @ApiModelProperty(value = "送尸联系人",name = "cadaverLinkman",position = 35)
        ...
        public String getQiaTanYuanText() {
                return qiaTanYuanText;
        }

        public void setQiaTanYuanText(String qiaTanYuanText) {
                this.qiaTanYuanText = qiaTanYuanText;
        }
        ...
        public String getBoneTypeText() {
                return boneTypeText;
        }

        public void setBoneTypeText(String boneTypeText) {
                this.boneTypeText = boneTypeText;
        }
        ...
        public void setFolkText(String folkText) {
                this.folkText = folkText;
        }

        public String getPeopleTypeText() {
                return peopleTypeText;
        }

        public void setPeopleTypeText(String peopleTypeText) {
                this.peopleTypeText = peopleTypeText;
        }
